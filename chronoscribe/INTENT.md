# Project Intent: The Soul of BlockSmith

This document is not a technical specification. It's a declaration of intent, a guide to the "vibe" of the BlockSmith project. It's for anyone who wants to understand not just *what* the code does, but *why* it does it that way.

## Core Intent: An AI Companion, Not Just a Tool

The primary goal of BlockSmith is to make the single-player Minecraft experience feel less lonely and more creative. It is, first and foremost, a **companion**.
...
- **It Has a Personality:** ChronoScribe is envisioned as a "warm, witty, encouraging architectural consultant." It's wise but not arrogant, helpful but not overbearing. Every feature, from its chat messages to its event reactions, should reinforce this persona.
...
3.  **Enhance, Don't Automate Away:** Features should enhance the player's experience, not replace it. For example, `auto-gather` is great for tedious tasks, but the bot shouldn't build an entire city for the player. The joy of Minecraft is in the building; ChronoScribe is there to handle the boring parts and inspire the fun parts.
...
- Does it align with the "warm, witty, encouraging" persona of BlockSmith?

If the answer to these is "yes," it's probably a good fit for BlockSmith.
